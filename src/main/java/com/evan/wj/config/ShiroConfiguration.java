...
public class ShiroConfiguration {
    ...
    @Bean
    public SecurityManager securityManager(WJRealm realm, CookieRememberMeManager rememberMeManager) {
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        hashedCredentialsMatcher.setHashAlgorithmName(WJConstants.ALGORITHMNAME_MD5);
        hashedCredentialsMatcher.setHashIterations(WJConstants.HASHITERATIONS);
